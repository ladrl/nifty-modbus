/* ==================================================================
 * ModbusExceptionTests.java - 23/06/2023 11:48:35 am
 *
...
/**
 * Test cases for the {@link ModbusException} class.
 *
 * @author matt
 * @version 1.0
 */
public class ModbusExceptionTests {
	...
	public void construct_default() {
		// WHEN
		ModbusException e = new ModbusException();
	...
	public void construct_message() {
		...
		// WHEN
		ModbusException e = new ModbusException(m);
	...
	public void construct_cause() {
		...
		// WHEN
		ModbusException e = new ModbusException(t);
	...
	public void construct_messageAndCause() {
		...
		// WHEN
		ModbusException e = new ModbusException(m, t);
